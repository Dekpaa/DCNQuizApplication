...
import 'package:quiz/controllers/quiz_paper/quiz_paper_controller.dart';
...
class QuizController extends GetxController {
  ...
  String get completedQuiz {
    final answeredQuestionCount = allQuestions
        ...
        .toList()
        .length;
    return '$answeredQuestionCount out of ${allQuestions.length} question answered';
  }
