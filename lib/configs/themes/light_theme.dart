...
const Color kPrimayLightColorLT = Color.fromARGB(255, 162, 203, 251);
const Color kPrimayColorLT = Color.fromARGB(255, 218, 142, 227);
  ...
  ThemeData buildLightTheme() {
    ...
    return systemLightTheme.copyWith(
        ...
        colorScheme: ColorScheme.fromSwatch(
            accentColor: kPrimayColorLT, primarySwatch: Colors.brown));
  }
}